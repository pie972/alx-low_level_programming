...
* You can find the source code [here](https://github.com/pie972/alx-low_level_programming/blob/master/0x01-variables_if_else_while/last_digit.c)
...
* All your code should be in the ***main*** function
```bash
pie@ubuntu:~/0x01$ gcc -Wall -pedantic -Werror -Wextra -std=gnu89 102-print_comb5.c -o 102-print_comb5
pie@ubuntu:~/0x01$ ./102-print_comb5
